...
public class TicketPriceLineController {
    ...
    public SuccessResponse<?> createTicketPriceDetail(@PathVariable int id, @RequestBody @Valid CreateTicketPriceDetailRequest request) {
        return new SuccessResponse<>(200, "success", "Thành công", ticketPriceLineService.createTicketPriceDetail(id,
                                                                                                                  request
        ));
    }
